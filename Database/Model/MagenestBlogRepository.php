...
use Magenest\Database\Model\ResourceModel\MagenestBlog\Collection;
use Magento\Framework\Api\SearchCriteriaInterface;
use Magento\Framework\Api\SortOrder;
use Magento\Framework\Exception\NoSuchEntityException;
use Magento\Framework\Exception\CouldNotDeleteException;

class MagenestBlogRepository implements \Magenest\Database\Api\MagenestBlogRepositoryInterface
{
    /**
     * @var \Magenest\Database\Model\MagenestBlogFactory
     */
    ...
    /**
     * @var \Magenest\Database\Api\Data\MagenestBlogSearchResultInterfaceFactory
     */
    protected $searchResultInterfaceFactory;

    /**
     * CustomRepository constructor.
     * @param \Magenest\Database\Model\MagenestBlogFactory $customFactory
     * @param ResourceModel\MagenestBlog $customResource
     * @param ResourceModel\MagenestBlog\CollectionFactory $collectionFactory
     * @param \Magenest\Database\Api\Data\MagenestBlogSearchResultInterfaceFactory $searchResultInterfaceFactory
     */
    public function __construct(
        \Magenest\Database\Model\MagenestBlogFactory $customFactory,
        \Magenest\Database\Model\ResourceModel\MagenestBlog $customResource,
        \Magento\UrlRewrite\Model\UrlRewriteFactory $urlRewriteFactory,
        \Magenest\Database\Model\ResourceModel\MagenestBlog\CollectionFactory $collectionFactory,
        \Magenest\Database\Api\Data\MagenestBlogSearchResultInterfaceFactory $searchResultInterfaceFactory
    ) {
