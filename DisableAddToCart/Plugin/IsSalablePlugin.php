 ...
 * IsSalable plugin
 *
 * @package   Magenest\DisableAddToCart
 * @author    Slawomir Magenest <slawek.bodak@gmail.com>
 * @copyright © 2017 Slawomir Magenest
 * @license   See LICENSE file for license details.
 */

declare(strict_types=1);

namespace Magenest\DisableAddToCart\Plugin;
 ...
 *
 * @category Plugin
 * @package  Magenest\DisableAddToCart\Plugin
 */
class IsSalablePlugin
{
    /**
