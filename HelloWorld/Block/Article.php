...
use \Magenest\HelloWorld\Model\ResourceModel\View\Collection as ViewCollection;
use \Magenest\HelloWorld\Model\ResourceModel\View\CollectionFactory as ViewCollectionFactory;
use \Magenest\HelloWorld\Model\View;
...
class Article extends Template
{
    ...
    public function getArticleUrl(
        ...
        return '/helloworld/view/id/' . $view->getId();
    }
